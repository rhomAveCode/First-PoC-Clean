var express = require('express'),
    ...
    db = require('mongojs').connect('sam');
...
app.get('/api/:query', function(req, res){
    res.redirect('/app/api/' + req.params.query);
});
app.get('/app/api/:collection', function(req, res) {
    var item, sort = {}, qw = {};
...
app.get('/api/:collection/:id', function(req, res){
    res.redirect('/app/api/' + req.params.collection + '/' + req.params.id);
});
app.get('/app/api/:collection/:id', function(req, res) {
    db.collection(req.params.collection).findOne({_id:objectId(req.params.id)}, fn(req, res))
});

// Save 
app.post('/api/:collection', function(req, res){
    res.redirect('/app/api/' + req.params.collection);
});
app.post('/app/api/:collection', function(req, res) {
...
app.del('/app/api/:collection/:id', function(req, res) {
...
app.put('/api/:collection/group', function(req, res){
    res.redirect('/app/api/' + req.params.collection + '/group');
});
app.put('/app/api/:collection/group', function(req, res) {
...
app.put('/api/:collection/mapReduce', function(req, res){
    res.redirect('/app/api/' + req.params.collection + '/mapReduce');
});
app.put('/app/api/:collection/mapReduce', function(req, res) {
...
app.put('/api/:collection/:cmd', function(req, res){
    res.redirect('/app/api/' + req.params.collection + '/' + req.params.cmd);
});
app.put('/app/api/:collection/:cmd',  function (req, res) {
